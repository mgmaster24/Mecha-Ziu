...
void CBloomShader::OnResetDevice()
{
	...
	m_vBlurOffsetsH[0] = D3DXVECTOR2	(-6.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[1] = D3DXVECTOR2	(-5.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[2] = D3DXVECTOR2	(-4.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[3] = D3DXVECTOR2	(-3.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[4] = D3DXVECTOR2	(-2.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[5] = D3DXVECTOR2	(-1.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[6] = D3DXVECTOR2	(0.0f,0.0f);
	m_vBlurOffsetsH[7] = D3DXVECTOR2	(1.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[8] = D3DXVECTOR2	(2.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[9] = D3DXVECTOR2	(3.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[10] = D3DXVECTOR2	(4.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[11] = D3DXVECTOR2	(5.0f / nBloomW,0.0f);
	m_vBlurOffsetsH[12] = D3DXVECTOR2	(6.0f / nBloomW,0.0f);

	m_vBlurOffsetsV[0] = D3DXVECTOR2	(0.0f, -6.0f / nBloomH);
	m_vBlurOffsetsV[1] = D3DXVECTOR2	(0.0f, -5.0f / nBloomH);
	m_vBlurOffsetsV[2] = D3DXVECTOR2	(0.0f, -4.0f / nBloomH);
	m_vBlurOffsetsV[3] = D3DXVECTOR2	(0.0f, -3.0f / nBloomH);
	m_vBlurOffsetsV[4] = D3DXVECTOR2	(0.0f, -2.0f / nBloomH);
	m_vBlurOffsetsV[5] = D3DXVECTOR2	(0.0f, -1.0f / nBloomH);
	m_vBlurOffsetsV[6] = D3DXVECTOR2	(0.0f, 0.0f);
	m_vBlurOffsetsV[7] = D3DXVECTOR2	(0.0f, 1.0f / nBloomH);
	m_vBlurOffsetsV[8] = D3DXVECTOR2	(0.0f, 2.0f / nBloomH);
	m_vBlurOffsetsV[9] = D3DXVECTOR2	(0.0f, 3.0f / nBloomH);
	m_vBlurOffsetsV[10] = D3DXVECTOR2	(0.0f, 4.0f / nBloomH);
	m_vBlurOffsetsV[11] = D3DXVECTOR2	(0.0f, 5.0f / nBloomH);
	m_vBlurOffsetsV[12] = D3DXVECTOR2	(0.0f, 6.0f / nBloomH);
