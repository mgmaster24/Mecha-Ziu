...
enum EFFECTS { PBULLET = 0, PENEMY_BULLET, PTURRET, PMINE, PMINE_EXPLOSION, PCHARGE_TURTLE, PENDCHARGE_TURTLE, PNO_SHIELD_HIT_TURTLE, PSHIELD_HIT_TURTLE, PHIT_TURTLE,
				PEXPLOSION_TURTLE, PCANNON_EXPLOSION_TURTLE, PTELEPORT, PEXPLOSION, PHIT, PTHRUSTER, PCHARGE, PENDCHARGE, PPLAYER_HIT, PHEALTH, PARMOR, PMISSILES,
				PSMOKE, PPICK_UP, FIRE_DOWN, FIRE_UP, FIRE_LEFT, FIRE_RIGHT, PHIT_TALBOT, PEXPLOSION_MICRO };
