...
public:
	...
	********************************************************************************/
	...
	inline unsigned int				GetMeshCount(unsigned int unModelIndex)	{ return m_Models[unModelIndex]->unMeshCount;	}
	...
	CSphere*						GetSphereByIndex(unsigned int unModelIndex, unsigned int unMeshIndex);
	D3DXMATRIX*						GetTransformByName(unsigned int unModelIndex, char* szName);
	D3DXMATRIX*						GetTransformByIndex(unsigned int unModelIndex, unsigned int unMeshIndex);
	...
	********************************************************************************/
	unsigned int	LoadModel(char* szFileName);
	...
	********************************************************************************/
	void			RenderSkyBox(unsigned int unModelIndex, D3DXMATRIX* maWorld = NULL, int nTextureIndex = -1, D3DXVECTOR2* vScale=NULL, D3DXVECTOR2* vTrans=NULL); 
	...
	********************************************************************************/
	...
	/********************************************************************************
	Description:	Renders a specific mesh of a model 
	********************************************************************************/
	void			RenderMesh(unsigned int unModelIndex, unsigned int unMeshIndex, D3DXMATRIX* maWorld);
	...
	********************************************************************************/
	...
	/********************************************************************************
	Description:	Reset the resolution to whatever value is in the game class
	********************************************************************************/
	void			ResetResolution();

	/********************************************************************************
	Description:	Check whether a resolutions is supported
	********************************************************************************/
	bool			CheckResolution(int nWidth, int nHeight);
